...
describe(Support.getTestDialectTeaser('Include'), () => {
  describe('findAll', () => {
    ...
    it('should allow through model to be paranoid', async function() {
      ...
      expect(user_customer.deleted).not.to.exist;
      ...
      const [nonDeletedUserCustomers, deletedUserCustomers] = _.partition(userCustomers, userCustomer => !userCustomer.deleted);
